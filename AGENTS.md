...
| `scripts/` | <!-- STAT:SCRIPTS-PY -->27<!-- /STAT:SCRIPTS-PY --> active Python scripts + <!-- STAT:SCRIPTS-OTHER -->2<!-- /STAT:SCRIPTS-OTHER --> non-Python runners (`responsive-qa.mjs`, `post-merge.sh`); 47 reference-only/retired Python scripts moved to `scripts/archive/` | Updated 2026-09-05; added the reviewed public-artifact staging/checker and catalog-claims gate. See `scripts/README.md` for active/archive classification. |
