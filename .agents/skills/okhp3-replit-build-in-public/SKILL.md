...
description: >
  ...
  organization for judges, artifact selection, dual deployment (Replit Publish
...
metadata:
  ...
  maturity: draftable
  in_scope:
    - Canvas organization for judge review (hero row, labeled zones, focusCanvasShapes)
...
## Canvas organization for judges
