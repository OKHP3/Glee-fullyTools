...
- Portable generator: 11 regression tests passed.
- Integration: 5 regression tests passed (addition/removal, idempotency, malformed-input preservation, marker safety, feedback exclusion).
